...
let
  ...
  hypr-monitors = ''
    monitor = DP-1, 1920x1080@74.97Hz, 0x0, 1
  ...
  hypr-keybindings = ''
    ...
    bind = $mainMod+ALT, F, fullscreen, # toggle the window between focus and fullscreen
    ...
    bind = $mainMod, Up, exec, pkill -x rofi || $scrPath/keybinds_hint.sh c # launch keybinds hint
